                        ...
                        <div class="small-dialog-content">
                            ...
                            <!-- Start of Registration form -->
                             <div class="form-group">
                                ...
                                @endif
                            <form  action="{{ route('admin.dashboard.store') }}" method="POST" autocomplete="off">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="admin_Key">Admin Key</label>
                                      <input id="admin_Key" type="text" class="form-control @error('admin_Key') is-invalid @enderror" name="admin_Key" value="{{ old('admin_Key') }}" required autocomplete="admin_Key"  placeholder="Admin Key..">
                            ...
                            <div class="bottom-links">
                                <span>
                                    ...
                                    <a href="{{ route('admin.dashboard.login') }}">Sign in</a>
                                </span>
                            </div>
